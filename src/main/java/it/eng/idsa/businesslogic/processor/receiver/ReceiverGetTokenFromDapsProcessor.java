...
@Component
public class ReceiverGetTokenFromDapsProcessor implements Processor {

	private static final Logger logger = LogManager.getLogger(ReceiverGetTokenFromDapsProcessor.class);
