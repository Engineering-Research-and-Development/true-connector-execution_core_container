...
public class EventTypeHandlerTest {
	...
	public void selfDescriptionAuditEventsSelected() {
		...
		assertFalse(eventTypeHandler.shouldAuditEvent(TrueConnectorEventType.CONNECTOR_BROKER_UNREGISTER));
	...
	public void connectorAuditEventsSelected() {
		...
		assertTrue(eventTypeHandler.shouldAuditEvent(TrueConnectorEventType.CONNECTOR_BROKER_UNREGISTER));
