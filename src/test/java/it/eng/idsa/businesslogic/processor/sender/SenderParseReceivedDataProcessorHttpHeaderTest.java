...
public class SenderParseReceivedDataProcessorHttpHeaderTest {
	...
	public void processHttpHeaderRequiredHeadersNotPresent() throws Exception {
		...
		doThrow(ExceptionForProcessor.class)
			.when(rejectionMessageService).sendRejectionMessage(null, RejectionMessageType.REJECTION_MESSAGE_LOCAL_ISSUES);
		...
		verify(rejectionMessageService).sendRejectionMessage(null, RejectionMessageType.REJECTION_MESSAGE_LOCAL_ISSUES);
	}
